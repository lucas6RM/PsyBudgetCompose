...
class LoginViewModel @Inject constructor(
    ...
    private val _goToRegisterSharedFlow = MutableSharedFlow<Boolean>()
    val goToRegisterSharedFlow = _goToRegisterSharedFlow.asSharedFlow()
    ...
    fun goToRegisterScreen(){
        viewModelScope.launch {
            _goToRegisterSharedFlow.emit(true)
        }
    }
